...
export function updateFeedback(id, newValue) {
  return firestore.collection('feedback').doc(id).update(newValue);
}
...
export async function createCheckoutSession(uid) {
  ...
  */
  ...
  const checkoutSessionRef = await firestore
    ...
    .add({
      price: 'price_1Hk36TKawtkOEuGTQODX7NKo', // price Id from firestore "price_1Hk364KawtkOEuGTvJunf01J" "price_1Hk36TKawtkOEuGTQODX7NKo", one time - price_1HkN65KawtkOEuGTcS8Nko6I
